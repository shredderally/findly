...
export default async function handler(req, res) {
  ...
  try {
    ...
    let query = supabase
      .from('businesses')
      // phone and whatsapp intentionally excluded — gated behind unlock payment
      .select('id, business_name, category, ghpost_gps_address, description, rating, review_count, verification_status')
