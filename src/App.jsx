...
export default function App() {
  ...
  // Top-rated = 4.5+ stars with at least 3 reviews.
  // Badge only — a trust signal for customers. Not tied to pricing;
  // contact is free and revealed the same way for every provider.
  function isTopRated(l) {
    return l.review_count >= 3 && l.rating >= 4.5;
  }
  ...
  async function submitReview(businessId) {
    ...
    try {
      ...
      setReviewedIds(prev => ({ ...prev, [businessId]: true }));
      ...
      <footer className="site-footer">
        <div className="footer-grid">
          <div className="footer-col footer-col-brand">
            <div className="footer-wordmark-sm">Findly</div>
            <p className="footer-tagline">ID-verified local service providers. Accra, Ghana.</p>
          </div>
          <div className="footer-col">
            <div className="footer-col-title">Browse</div>
            <a onClick={() => setView('browse')}>All providers</a>
            <a onClick={() => { setCategory(''); setView('browse'); }}>By category</a>
          </div>
          <div className="footer-col">
          ...
          <div className="footer-col">
            ...
            <a onClick={() => setView('terms')}>Terms</a>
            <a onClick={() => setView('privacy')}>Privacy</a>
          </div>
        </div>

        <div className="footer-wordmark-lg" aria-hidden="true">Findly</div>
        ...
        <div className="footer-bottom">
          ...
          <span className="footer-imprint">© Northbound Holdings 2026</span>
    ...
    <div className="app lp">
      ...
      <div className="lp-pricing">
        ...
        <div className="lp-pricing-col lp-pricing-customer">
          ...
          <div className="lp-pricing-free">Browse, contact, and review any provider — completely free.</div>
        </div>
      </div>
  ...
  if (view === 'browse') return (
    <div className="app"><Header />
      ...
      {listings.map(l => {
        ...
        const reviewFormOpen = reviewFormOpenId === l.id;
        const alreadyReviewed = reviewedIds[l.id];
        return (
          <div className="listing" key={l.id}>
            ...
            {/* Contact — always visible, no gate */}
            <div className="contact-row">
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, flex: 1, flexWrap: 'wrap' }}>
                {isTopRated(l) && <span className="top-rated-badge">⭐ TOP RATED</span>}
            ...
            {!alreadyReviewed && !reviewFormOpen && (
              <button
                className="btn-review-toggle"
                onClick={() => { setReviewFormOpenId(l.id); setReviewForm({ reviewerName: '', rating: 5, comment: '' }); }}
              >
                Leave a review
              </button>
            )}
            {!alreadyReviewed && reviewFormOpen && (
              <div className="review-form">
                <div className="review-form-label">How was it?</div>
                ...
                <div style={{ display: 'flex', gap: 8 }}>
                  ...
                  <button
                    className="btn-back"
                    onClick={() => setReviewFormOpenId(null)}
                  >
                    Cancel
                  </button>
                </div>
      ...
      <div className="auth-pg"><div className="auth-c" style={{ maxWidth: 440 }}>
        ...
        {step === 3 && (
          <>
            ...
            <div className="sub">We verify every provider manually. After you submit, we'll contact you on the phone number you provided to collect your Ghana Card or Voter's ID. Your documents are never shown publicly.</div>
            <div className="verify-notice">
              <div className="verify-notice-icon">🔒</div>
              <div>
                <div style={{ color: 'var(--text)', fontSize: 14, fontWeight: 600, marginBottom: 4 }}>What happens next</div>
                <div style={{ color: 'var(--muted)', fontSize: 13, lineHeight: 1.6 }}>
                  1. Submit your application<br />
                  2. We contact you on WhatsApp to collect your ID<br />
                  3. Review takes 1–2 days<br />
                  4. You get a notification when approved
                </div>
              </div>
            </div>
            <button className="btn btn-clay" style={{ width: '100%' }} onClick={() => setStep(4)}>
              Continue
            </button>
