...
export default function App() {
  ...
  // Contact gated behind GHS 2 — signals premium quality.
  // At launch nobody qualifies yet so all contacts are free by default.
    ...
    <div className="app lp">
      ...
      <div className="lp-pricing">
        ...
        <div className="lp-pricing-col lp-pricing-customer">
          ...
          <div className="lp-pricing-free">Browse and contact freely. Top-rated providers (⭐ 4.5+) cost GHS 2 to unlock.</div>
        </div>
      </div>
      ...
      {listings.map(l => {
        ...
        return (
          <div className="listing" key={l.id}>
            ...
            {/* Free for all providers. Top-rated (4.5★, 3+ reviews) = GHS 2 unlock */}
            <div className="contact-row">
              {isTopRated(l) && !unlockedContacts[l.id] ? (
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, flex: 1 }}>
                  <div>
                    <span className="top-rated-badge">⭐ TOP RATED</span>
                    <div style={{ color: 'var(--muted)', fontSize: 12, marginTop: 4 }}>
                      Unlock contact — GHS 2
                    </div>
                  </div>
                  <button
                  ...
                  >
                    {unlockingId === l.id ? 'Loading...' : '🔒 GHS 2'}
                  </button>
                </div>
              ) : (
